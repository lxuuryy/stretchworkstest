      ...
      <nav className="fixed top-0 w-full z-50 bg-black/40 backdrop-blur-xl border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex gap-8 text-sm font-semibold text-white/70">
            ...
            <a href="/recovery-and-injury-support" className="text-white">Recovery & Injury</a>
      ...
      <section id="book" className="py-32 px-6 bg-[#f8fbfe]">
        <div className="max-w-4xl mx-auto">
          <div className="rounded-3xl p-12 md:p-16 text-center text-white" style={{ background: "linear-gradient(145deg, #002256 0%, #18a3dd 100%)", boxShadow: "0 24px 60px rgba(24,163,221,0.2)" }}>
            ...
            <p className="mt-5 text-sm text-white/40">Movement does not have to feel this hard. No credit card. No lock-in.</p>
          </div>
        </div>
      </section>
