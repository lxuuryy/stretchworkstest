...
const cards = [
  {
    ...
    icon: "🩹",
    sport: "Post Injury",
    quote: "I'm technically better, but I still don't move like myself.",
    detail: "Getting cleared isn't the same as feeling right. Assisted stretching helps you rebuild range, ease, and confidence in your body after injury. at your pace.",
  },
  {
    n: "02",
    icon: "🏥",
    sport: "After Surgery or Inactivity",
    quote: "Everything feels tighter after being off my feet.",
    detail: "Time off changes how your body moves. We work gently through the restrictions that build up so you can get back to feeling like yourself again.",
  },
  {
    n: "03",
    icon: "🧠",
    sport: "Complex Movement Conditions",
    quote: "I need something more tailored than a class or standard program.",
    detail: "Neurological conditions, chronic tightness, or complex histories need individual attention. not a generic routine. Every session is built around you.",
  },
  {
    n: "04",
    icon: "🚶",
    sport: "Daily Life",
    quote: "Simple things should not feel this hard.",
    detail: "Getting up, walking, reaching. movement should feel easy. If it doesn't, that's worth addressing. We help you find ease in the things that matter most.",
  },
];
        ...
        <div className="grid md:grid-cols-2 gap-20 items-start">
          ...
          <div className="md:sticky md:top-32">
            ...
            >
              ...
              <br />For Help That Fits.
            </h2>
            <p className="mt-7 text-gray-500 leading-relaxed max-w-xs">
              If your body has changed after injury, surgery, illness, or long periods of inactivity. you need calm, personalised support. Not a class. Not intensity.
            </p>
