...
export default function AgingPage() {
  return (
    <div className="min-h-screen bg-white text-[#1a1a2e] antialiased" style={{ fontFamily: "var(--font-open-sans), sans-serif" }}>
      ...
      {/* WHO IT'S FOR */}
      <section id="who-it-s-for" className="py-24 px-6 bg-[#f8fbfe]">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl">
              <Image src="/firstVisit.jpg" alt="StretchWorks session" width={700} height={600} className="w-full h-full object-cover" />
